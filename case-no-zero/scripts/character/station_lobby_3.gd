...
func _ready():
	print("🔍 station_lobby_3: _ready() called")
	...
	if interaction_area:
		...
		print("🔍 station_lobby_3: Area2D signals connected")
	else:
		print("⚠️ station_lobby_3: No Area2D found!")
	...
	if animated_sprite:
		...
		print("🔍 station_lobby_3: Animation started")
...
func load_dialogue():
	var file: FileAccess = FileAccess.open("res://data/dialogues/station_lobby_3_dialogue.json", FileAccess.READ)
	if file == null:
		push_error("Cannot open station_lobby_3_dialogue.json")
		return
	...
	if typeof(parsed) != TYPE_DICTIONARY or not parsed.has("station_lobby_3"):
		push_error("Failed to parse station_lobby_3_dialogue.json")
		return
	
	dialogue_data = parsed["station_lobby_3"]
	print("✅ Loaded Station Lobby 3 dialogue")

func _on_body_entered(body):
	print("🔍 station_lobby_3: Body entered - ", body.name)
	if body.name == "PlayerM":
		is_player_nearby = true
		player_reference = body
		show_interaction_label()
		print("👮 Player near station lobby 3")
...
func _on_body_exited(body):
	if body == player_reference:
		...
		print("👮 Player left station lobby 3")

func show_interaction_label():
	print("🔍 station_lobby_3: Showing interaction label")
...
func interact():
	print("💬 Interacting with station lobby 3")
...
func show_dialogue():
	...
	print("==================================================")
	print("📋 STATION LOBBY 3 DIALOGUE:")
